    ...
    def _serialize_event_stream(
        ...
        def event_stream_serializer() -> Iterable[bytes]:
            ...
            for event in event_generator:
                print("event from event generator in serializer", event)
                ...
                print("serializer shape/name", event_member_shape, event_member_name)
                ...
                print("serialized response event", serialized_event_response.data)
